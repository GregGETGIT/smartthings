...
def allHolidayList() {
    ...
    [name: "Presidents Day", day: '02/19', colors: ["Red", "White", "Blue" ] ],
    [name: "St. Patrick's Day", day: '03/17', colors: ["Green", "Orange"] ],
    [name: "Easter", day: '04/01', colors: [ 'Pink', 'Turquoise', 'Aqua' ] ],
    [name: "Mothers Day", day: '05/13', colors: ['Red', 'Pink'] ],
    [name: "Memorial Day", day: '05/28', colors: ["Red", "White", "Blue" ] ],
    [name: "Fathers Day", day: '06/17', , colors: ["Blue", "Navy Blue"] ],
    [name: "Independence Day", day: '07/04', colors: ["Red", "White", "Blue" ] ],
    [name: "Labor Day", day: '09/03', colors: ["Red", "White", "Blue" ] ],
    [name: "Halloween", day: '10/31', colors: ['Orange', 'Safety Orange' ] ],
    [name: "Veterans Day", day: '11/11', colors: ["Red", "White", "Blue" ] ],
    [name: "Thanksgiving", day: '11/22', colors: ['Orange', 'Safety Orange' ] ],
